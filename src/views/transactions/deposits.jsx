...
const Users = () => {
  ...
  const getDeposits = () => {
    axios
      .get(
        `${config.baseUrl}/api/v1/admin/transactions/fund-wallet?pageNumber=1&pageSize=100`,
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("token")}`,
          },
  ...
  const getDepositsAll = () => {
    axios
      .get(
        `${config.baseUrl}/api/v1/admin/transactions/fund-wallet?pageNumber=1&pageSize=999999999`,
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("token")}`,
          },
