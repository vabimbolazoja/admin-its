...
const Users = () => {
  ...
  const getKycPaged = (queryString) => {
    axios
      .get(`${config.baseUrl}/api/vGated/admin/artisan-kyc/all?${queryString}`, {
        headers: {
  ...
  const getUsersKyc = () => {
    axios
      .get(
        `${config.baseUrl}/api/vGated/admin/artisan-kyc?pageNumber=1&pageSize=100&accountType=&country=&kycApprovalStatus=DUE_DELIGENCE`,
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("token")}`,
          },
  ...
  const getUsersKycAll = () => {
    axios
      .get(
        `${config.baseUrl}/api/vGated/admin/artisan-kyc?pageNumber=1&pageSize=999999999&accountType=&country=&identityVerificationStatus=ACCEPTED`,
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("token")}`,
          },
  ...
  const approve = (id, e) => {
    ...
    axios
      .post(
        `${config.baseUrl}/api/vGated/admin/artisan-kyc/${id}/approve`,
        {},
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("token")}`,
  ...
  const decline = (id, e) => {
    if (reason) {
      ...
      axios
        .post(
          `${config.baseUrl}/api/vGated/admin/artisan-kyc/${userId.id}/reject/${reason}`,
          {
