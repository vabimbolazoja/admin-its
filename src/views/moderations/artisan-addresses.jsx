...
const Admins = (props) => {
    ...
    const categoryEnable = () => {
        axios
            .post(
                `${config.baseUrl}/api/vGated/admin/moderation/artisan-addresses/${catId}/approve`,
                {},
                {
                    headers: {
                        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
    ...
    const categoryDisable = () => {
        ...
        axios
            .post(
                `${config.baseUrl}/api/vGated/admin/moderation/artisan-addresses/${catId}/reject/${reason}`,
                {},
                {
                    headers: {
                        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
    ...
    const getAddresses = () => {
        axios
            .get(`${config.baseUrl}/api/vGated/admin/moderation/artisan-addresses?pageNumber=1&pageSize=100`, {
                headers: {
                    Authorization: `Bearer ${sessionStorage.getItem("token")}`,
                },
            })
                ...
                <CCard>
                    <CCardHeader>
                        <div className="d-flex justify-content-between align-items-center">
                            <p>Artisan Address Moderation</p>
