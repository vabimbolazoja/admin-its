...
const Admins = (props) => {
    ...
    const categoryEnable = () => {
        axios
            .post(
                `${config.baseUrl}/api/vGated/admin/moderation/customer-addresses/${catId}/approve`,
                {},
                {
                    headers: {
                        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
    ...
    const categoryDisable = () => {
        ...
        axios
            .post(
                `${config.baseUrl}/api/vGated/admin/moderation/customer-addresses/${catId}/reject/${reason}`,
                {},
                {
                    headers: {
                        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
    ...
    const getAddresses = () => {
        axios
            .get(`${config.baseUrl}/api/vGated/admin/moderation/customer-addresses?pageNumber=1&pageSize=100`, {
                headers: {
                    Authorization: `Bearer ${sessionStorage.getItem("token")}`,
                },
            })
                ...
                if (res.status === 200) {
                    ...
                    setAdminRecordData(
                        res.data.records.map((data) => ({
                            ...
                            file: data.addressVerificationFile,
                ...
                <CCard>
                    <CCardHeader>
                        <div className="d-flex justify-content-between align-items-center">
                            <p>Customer Address Moderation</p>
