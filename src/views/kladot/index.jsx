...
const KudaAccount = () => {
  ...
  const getJobs = () => {
    axios
      .get(`${config.baseUrl}/api/v1/admin/jobs`, {
        headers: {
  ...
  const pause = (id, e) => {
    ...
    axios
      .post(
        `${config.baseUrl}/api/v1/admin/jobs/${id.group}/pause?keyName=${id.name}`,
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("token")}`,
          },
  ...
  const resume = (id, e) => {
    ...
    axios
      .post(
        `${config.baseUrl}/api/v1/admin/jobs/${id.group}/resume?keyName=${id.name}`,
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("token")}`,
          },
